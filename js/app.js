...
function sumAndMultiply(a, b, c) {
  let num1_sum = sum(a, b);
  let num2_sum = sum(0, c);

  let num1_product = multiply(a, b);
  let num2_product = multiply(1, c);

  let result_sum = sum(num1_sum[0], num2_sum[0]);
  let result_product = multiply(num1_product[0], num2_product[0]);

  // console.log("RESULT SUM:", result_sum);
  // console.log("RESULT PRODUCT: ", result_product);

  let message_for_sum = `${a} and ${b} and ${c} sum to ${result_sum[0]}.`;
  let message_for_product = `The product of ${a} and ${b} and ${c} is ${result_product[0]}.`;

  // console.log("MFS", message_for_sum);
  // console.log("MFP", message_for_product);
  return [
    result_sum[0],
    result_product[0],
    message_for_sum,
...
is the sum of the numbers in the array, and the second element is a string that EXACTLY follows 
...
function sumArray(sumArr) {
  let sumArrayString = sumArr.toString();
...
function multiplyArray(multArr) {
  let multiplyArrayString = multArr.toString();
